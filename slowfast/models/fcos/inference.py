...
def make_fcos_postprocessor(config):
    pre_nms_thresh = 0.05 # config.MODEL.FCOS.INFERENCE_TH
    pre_nms_top_n = 1000 # config.MODEL.FCOS.PRE_NMS_TOP_N
    nms_thresh = 0.6 # config.MODEL.FCOS.NMS_TH
    fpn_post_nms_top_n = 100 # config.TEST.DETECTIONS_PER_IMG
